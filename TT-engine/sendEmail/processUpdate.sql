...
# Помечаем что по этому ТТ мы email update  отправили для всех с transition 61 и 63 
  ...
  WHERE zapisi_trubl_tic.num_trubl ='@numTT' AND zapisi_trubl_tic.transition = '63' AND num_zap_trubl <= '@lstzap';

UPDATE klients.zapisi_trubl_tic 
  SET  transition = '62', col_centr = '2'
  WHERE zapisi_trubl_tic.num_trubl ='@numTT' AND zapisi_trubl_tic.transition = '61' AND num_zap_trubl <= '@lstzap';
