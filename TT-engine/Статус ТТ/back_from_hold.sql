...
# Получить список ТТ которые нужно вывести из отложенных по каждому тт независимо от того за кем он закреплен, до момента выведения 
...
# Важно, если запрос не возвращает ничего - ТТ пропускаем ничего с ним не делаем, статус ему не меняем.
