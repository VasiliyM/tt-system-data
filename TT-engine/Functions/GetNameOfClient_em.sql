...
BEGIN
      ...
      begin
        ...
        else RETURN concat('Тех.площадка - ',Node,' - ',Twn,', ',Adr);
        end if;
      end;
      END IF;
      IF tab_on=4 THEN
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            RETURN concat('СС - ',NMS,' ',p_a,' -- ',p_b,' ',Kli,' Скорость: ',Ps,' Мбит/с');
          end;
          else
          begin
            DECLARE NMS2 VARCHAR(250);
            SELECT `name_nms` INTO NMS2 FROM net_equip WHERE `id_equip`=e_b;
            RETURN concat('СС - ',NMS,' ',p_a,' -- ',p_b,' ',NMS2,' Скорость: ',Ps,' Мбит/с');
          end;
          end if;
        end;
        end if;
              ...
              BEGIN
                      ...
                      if Sp=NULL then SET nSp='?';
                          ...
                          IF Em_profil = 'BASE_EN' THEN BEGIN
                                                        ...
                                                        END;
                          ELSE RETURN concat(Kl,', ',sk_type,', ',nSp,' Мбит/с, (',Twn2,', ',St2,')');
                          END IF;
              END;
          else begin
                if Twn=Twn2 then
                    begin
                        ...
                        if Sp=NULL then SET nSp='?';
                          ...
                          IF Em_profil = 'BASE_EN' THEN BEGIN
                                                        ...
                                                        END;
                          ELSE RETURN concat(Kl,', ',sk_type,', ',nSp,' Mбит/с, (',Twn,', ',St,' - ',St2,')');
                          END IF;
                    end;
                else
                    begin
                      ...
                      if Sp=NULL then SET nSp='?';
                          ...
                          IF Em_profil = 'BASE_EN' THEN BEGIN
                                                        ...
                                                        END;
                          ELSE RETURN concat(Kl,', ',sk_type,', ',nSp,' Мбит/с, (',Twn,', ',St,' - ',Twn2,', ',St2,')');
                          END IF;
                    end;
                end if;
              END;
      ...
      begin   
        ...
        begin
          ...
          RETURN concat('ССУ - ',Kli,', ',Twn,', ',s_a,' - ',Twn2,', ',s_b);
        end;
        end if;
      end;
      END IF;
